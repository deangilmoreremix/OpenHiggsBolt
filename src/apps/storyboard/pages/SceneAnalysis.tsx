    ...
    <div className="p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          <button className="p-2 rounded-xl hover:bg-[var(--bg-card)] transition-colors">
            <ArrowLeft size={20} />
          </button>
        ...
        <div className="glass p-6 rounded-xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="glass-panel p-4 rounded-xl">
              ...
              <p className="text-sm text-muted">Epic, motivational, cinematic</p>
            </div>
            <div className="glass-panel p-4 rounded-xl">
              <p className="font-medium mb-1">Similar to: Audiomachine - Blood and Stone</p>
              <p className="text-sm text-muted">Dark, intense, powerful</p>
            </div>
          </div>
        </div>
      </div>
