...
function ImageStudio(_ref6) {
  ...
  var _useState33 = (0, _react.useState)(null),
    ...
    dropdownOpen = _useState34[0],
    setDropdownOpen = _useState34[1]; // 'model' | 'ar' | 'quality' | null
  var _useState35 = (0, _react.useState)(false),
    _useState36 = _slicedToArray(_useState35, 2),
    generating = _useState36[0],
    setGenerating = _useState36[1];
  ...
  var _useState41 = (0, _react.useState)(false),
    ...
    isDrawModalOpen = _useState42[0],
    setIsDrawModalOpen = _useState42[1];

  // ── Canvas / history state ──────────────────────────────────────────────
  var _useState43 = (0, _react.useState)(null),
    _useState44 = _slicedToArray(_useState43, 2),
    currentImageUrl = _useState44[0],
    setCurrentImageUrl = _useState44[1];
  var _useState45 = (0, _react.useState)(0),
    _useState46 = _slicedToArray(_useState45, 2),
    activeHistoryIdx = _useState46[0],
    setActiveHistoryIdx = _useState46[1];
  var _useState47 = (0, _react.useState)(1),
    _useState48 = _slicedToArray(_useState47, 2),
    batchSize = _useState48[0],
    setBatchSize = _useState48[1];
  var _useState49 = (0, _react.useState)([]),
    _useState50 = _slicedToArray(_useState49, 2),
    localHistory = _useState50[0],
    setLocalHistory = _useState50[1]; // [{id,url,prompt,model,aspect_ratio,timestamp}]
