...
function AiInfluencerStudio(_ref2) {
  ...
  (0, _react.useEffect)(function () {
    var pending = (0, _skillStore.getPendingRecipe)("ai-influencer");
    if (!pending) return;
    var skill = _registry["default"].skills.find(function (s) {
      return s.slug === pending;
    });
    (0, _skillStore.clearPendingRecipe)("ai-influencer");
    if (!skill) return;
    applyRecipe(skill);
  ...
  function applyRecipe(skill) {
    ...
    setCustomPrompt((0, _promptRecipes.fillTemplate)(step0.prompt || skill.description || "", vals));
  }
  ...
  var _useTemplateData = (0, _useTemplateData2.useTemplateData)(templateData, function (data) {
      ...
      if (data.aspectRatio) {
        var normalized = (0, _useTemplateData2.normalizeAspectRatio)(data.aspectRatio, "3:4");
          ...
          return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("img", {
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
                ...
                mediaUrl: item.url,
                mediaType: "image",
                title: "Influencer #".concat(history.length - idx),
                className: "p-1.5 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 transition-all cursor-pointer"
              }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_AiAssistantProvider.AssistStep, {
                assetUrl: item.url,
                assetType: "image",
