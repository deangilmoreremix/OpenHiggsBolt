...
var inputHandles = ["videoInput7" // videos_list
];
var outputHandles = ["videoOutput"];
var VideoCombiner = function VideoCombiner(_ref) {
  var _data$runId, _nodeSchemas$categori, _outputHistory$curren, _currentOutputList$cu, _currentOutputList$;
  var id = _ref.id,
    data = _ref.data,
    selected = _ref.selected;
  var models = (0, _react.useMemo)(function () {
    var _data$nodeSchemas;
    return (_data$nodeSchemas = data.nodeSchemas) !== null && _data$nodeSchemas !== void 0 && (_data$nodeSchemas = _data$nodeSchemas.categories) !== null && _data$nodeSchemas !== void 0 && (_data$nodeSchemas = _data$nodeSchemas.utility) !== null && _data$nodeSchemas !== void 0 && _data$nodeSchemas.models ? Object.values(data.nodeSchemas.categories.utility.models) : [];
  }, [data.nodeSchemas]);
  var _useState = (0, _react.useState)(data.selectedModel || models[0] || {}),
  ...
  var hasVideosList = properties && "videos_list" in properties;
  (0, _react.useEffect)(function () {
    var timeout = setTimeout(function () {
      var validHandles = [hasVideosList && "videoInput7"].filter(Boolean);
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, "Video Combiner ", id.replace(/^\D+/g, "")), generationCost !== null && !(selectedModel !== null && selectedModel !== void 0 && selectedModel.id.includes("passthrough")) && /*#__PURE__*/_react["default"].createElement("span", {
  ...
  }, "Combining...")) : data.errorMsg ? /*#__PURE__*/_react["default"].createElement("div", {
    className: "text-red-400 text-xs font-medium p-3 bg-red-500/10 rounded-xl border border-red-500/20 m-3 w-full capitalize"
  }, data.errorMsg) : currentOutput ? /*#__PURE__*/_react["default"].createElement("div", {
    ...
    className: "absolute -left-10 top-[100px] text-xs text-orange-500 transition-opacity duration-200 ".concat(data.activeHandleColor === "orange" ? "opacity-100" : "opacity-0 group-hover:opacity-100")
...
var _default = exports["default"] = VideoCombiner;